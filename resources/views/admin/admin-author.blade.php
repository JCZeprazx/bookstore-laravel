                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <a href="{{url('author-pdf')}}" class="btn btn-danger mb-3">Export to PDF</a>
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                        ...
                                        <form action="/admin/author/edit/{{ $name->id }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" name="author_firstname" type="text"
                                                    ...
                                                    autocomplete="firstname" aria-required="true" aria-invalid="false"
                                                    aria-describedby="firstname" value="{{ $name->author_firstname }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="lastname" name="author_lastname" type="text"
                                                    ...
                                                    data-val-required="Please enter the name on card"
                                                    autocomplete="lastname" aria-required="true" aria-invalid="false"
                                                    aria-describedby="lastname" value="{{ $name->author_lastname }}">
                                                <span class="help-block field-validation-valid"
                                    ...
                                    <x-modal titleModal="Delete Data" idModal="destroy{{ $name->id }}">
                                        <form action="/admin/author/delete/{{ $name->id }}" method="post"
                                            class="form-horizontal">
                                            @method('DELETE')
                                            @csrf
...
<x-modal titleModal="Tambah Data" idModal="tambahData">
    <form action="/admin/author/input" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <input id="lastname" name="author_lastname" type="text" class="form-control lastname valid" data-val="true"
                data-val-required="Please enter the name on card" autocomplete="lastname" aria-required="true"
