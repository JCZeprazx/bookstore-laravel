                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="/admin/book/edit/{{ $id }}" method="post" class="form-horizontal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="book_name" name="book_name" type="text"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="book_name" value="{{ $book->book_name }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="total_page" name="total_page" type="number"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="total_page" value="{{ $book->total_page }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="release_date" name="release_date" type="date"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="release_date" value="{{ $book->release_date }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="book_description" name="book_description" type="textarea" class="form-control book_description valid"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="book_description" value='{{ $book->book_description }}'></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="language_id" id="select" class="form-control">
                                             <option value="{{ $book->language_id }}">{{ $book->language->language }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="select" class=" form-control-label">Publisher</label>
                                        <select name="publisher_id" id="select" class="form-control">
                                            <option value="{{ $book->publisher_id }}">{{ $book->publisher->publisher_name }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="book_cost" name="book_cost" type="number"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="book_cost" value="{{ $book->book_cost }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="total_stock" name="total_stock" type="number"
                                            ...
                                            aria-required="true" aria-invalid="false" aria-describedby="total_stock" value="{{ $book->total_stock }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('storage/app/public/photo/'. $book->book_cover) }}" alt="">
                                    </div>
