...
Route::get('author-pdf', [AuthorController::class, 'authorPDF']);
Route::get('publisher-pdf', [PublisherController::class, 'publisherPDF']);
Route::get('buku-pdf', [BookController::class, 'bukuPDF']);